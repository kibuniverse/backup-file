...
hs.hotkey.bind(alt, '1', function() toggle_app('Warp') end)
hs.hotkey.bind(alt, '2', function() toggle_app('Visual Studio code') end)
hs.hotkey.bind(alt, 's', function() toggle_app('Google Chrome') end)
hs.hotkey.bind(alt, 'x', function() toggle_app('qq') end)
hs.hotkey.bind(alt, 'i', function() toggle_app('idea') end)
hs.hotkey.bind(alt, 'd', function() toggle_app('music') end)
hs.hotkey.bind(alt, 'a', function() toggle_app('Lark') end)
hs.hotkey.bind(alt, 't', function() toggle_app('Typora') end)
...
hs.hotkey.bind(alt, 'r', function() toggle_app('RunJS') end)
hs.hotkey.bind(alt, 'p', function() toggle_app('WPS') end)
